    ...
    def forward(
        ...
        if self.use_cam: # False in demo 
            ...
            if isinstance(hmr_output['pred_pose'], list):
                ...
                smpl_output = self.smpl(         # output['smpl_joints2d'] = joints2d
        ...
        return smpl_output # [('smpl_vertices', torch.Size([16, 6890, 3])), ('smpl_joints3d', torch.Size([16, 49, 3])), ('smpl_joints2d', torch.Size([16, 49, 2])), ('pred_cam_t', torch.Size([16, 3])), ('pred_segm_mask', torch.Size([16, 25, 56, 56])), ('pred_pose', torch.Size([16, 24, 3, 3])), ('pred_cam', torch.Size([16, 3])), ('pred_shape', torch.Size([16, 10]))]
