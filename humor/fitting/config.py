...
def parse_args(argv):
    ...
    parser.add_argument('--data-type', type=str, required=True, choices=['AMASS', 'PROX-RGB', 'PROX-RGBD', 'iMapper-RGB', 'RGB', 'PARE'], help='The type of data we are fitting to.')
    ...
    parser.set_defaults(save_stages_results=False)
        ...
        # option on pare 
    CFG = '/apdcephfs/share_1290939/shaolihuang/data/VIBE-pare/pare_data/pare/checkpoints/pare_w_3dpw_config.yaml'
    CKPT = '/apdcephfs/share_1290939/shaolihuang/data/VIBE-pare/pare_data/pare/checkpoints/pare_w_3dpw_checkpoint.ckpt'
