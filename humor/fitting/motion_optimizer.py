...
class MotionOptimizer():
    ...
    def __init__(self, device,
                       ...
                       use_chamfer=False,
                       im_dim=(1080,1080),
                       datatype=None): # image dimensions to use for visualization
    ...
    def initialize(self, observed_data):
        ...
        if self.optim_floor:
            ...
            if 'points3d' in observed_data:
                ...
                joints2d_conf = torch.ones_like(observed_data['joints2d'][:,:,:,0]) if self.datatype == 'PARE' else observed_data['joints2d'][:,:,:,2]
